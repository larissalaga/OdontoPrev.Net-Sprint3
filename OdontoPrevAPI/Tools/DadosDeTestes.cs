...
namespace OdontoPrevAPI.Tools
{
    public static class DadosDeTestes
    {
        ...
        {
            new PacienteDtos { NmPaciente = "Beto Mal Hálito", DtNascimento = DateTime.Parse("1990-02-06"), NrCpf = "09317440088", DsSexo = "M", NrTelefone = "27965563215", DsEmail = "beto.halito@gmail.com", IdPlano = 1 },
            ...
            new PacienteDtos { NmPaciente = "João Tártaro", DtNascimento = DateTime.Parse("1992-02-06"), NrCpf = "12724268075", DsSexo = "M", NrTelefone = "35932100586", DsEmail = "joao.tartaro@gmail.com", IdPlano = 4 },
        ...
        public static List<(string Descricao, byte[] Imagem, string Data, int IdPaciente)> ListaRaioX = new()
        {
            ...
            ("Raio_x do pré-molar", null, "08/03/2024", 3),
            ("Raio_x do canino", null, "11/04/2024", 4),
            ("Raio_x panorâmico", null, "15/05/2024", 5),
            ("Raio_x da mandíbula", null, "19/06/2024", 6),
